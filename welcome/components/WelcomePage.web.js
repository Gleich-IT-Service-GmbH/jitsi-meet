...
import { PlannedMeetingList } from '../../planned-meetings/components';
...
class WelcomePage extends AbstractWelcomePage {
    ...
    constructor(props) {
        ...
        this._setLoginState = this._setLoginState.bind(this);
    }
            ...
            <div
                ...
                <div className = 'header'>
                    <div className = 'welcome-page-settings'>
                        <LoginButton
                            setLoginState = { this._setLoginState }
    ...
    _renderTabs() {
        ...
        if (this.state.isLoggedIn) {
            tabs.push({
                label: t('welcomepage.plannedMeetings'),
                content: <PlannedMeetingList />
            })
        }
